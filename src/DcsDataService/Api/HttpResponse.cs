...
namespace DcsDataService.Api
{
    public sealed class HttpResponse
    {
        ...
        public byte[] ToBytes()
        {
            byte[] body = Encoding.UTF8.GetBytes(Body ?? ""); string reason = StatusCode == 200 ? "OK" : StatusCode == 400 ? "Bad Request" : StatusCode == 401 ? "Unauthorized" : StatusCode == 404 ? "Not Found" : StatusCode == 405 ? "Method Not Allowed" : StatusCode == 409 ? "Conflict" : StatusCode == 413 ? "Payload Too Large" : StatusCode == 503 ? "Service Unavailable" : "Internal Server Error";
